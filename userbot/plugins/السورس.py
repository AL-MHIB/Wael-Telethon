...
async def _(event):
    ...
    OUTPUT = (f"☭︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس المهيب  :**\n\n{o}")
...
async def iq(event):
    await edit_or_reply(event, """✐  ⦗ اوامـر سـورس المهيب  ⦘
                                             ┉┉┉┉┉┉×┉┉┉┉┉
〖`.م1`〗⏎  اوامر الحساب 1
〖`.م2`〗⏎  اوامر الحساب 2
〖`.م3`〗⏎  اوامر الحساب 3
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**☭︙ قـائمـه الاوامـر :**\n**☭︙ قنـاه السـورس :** @E999GI\n**☭︙ شـرح اوامـر السـورس : @E999GI**\n**☭︙ شـرح فـارات السـورس : @E999GI** "
